...
public class BoardViewer 
{
	...
	private final int APPLICATION_SIZE_HBOARD_MAX_HEIGHT = 1000;
	private boolean colorShifter;
	private HashMap<String, Square> squareMap;
	
	private final int BOARD_MAX_HEIGHT = 8;
	...
	public BoardViewer()
	{
		...
		frame.pack();
		frame.setSize(APPLICATION_SIZE_WIDTH, APPLICATION_SIZE_HBOARD_MAX_HEIGHT);
		frame.setLocationRelativeTo(null);
		frame.setLayout(new GridLayout(BOARD_MAX_HEIGHT,BOARD_MAX_HEIGHT));
	...
	public void makePanels()
	{
		...
		for(int j = BOARD_MAX_HEIGHT; j > 0; j--)
		{
